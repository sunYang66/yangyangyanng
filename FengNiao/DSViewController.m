...
@interface DSViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>{
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    page = 1;
    self.urlStr = @"http://api.fengniao.com/app_ipad/pic_zutu_list.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&cid=192&page=%d";
