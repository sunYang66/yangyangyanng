...
@interface LYViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>{
...
- (void)createView{
    HttpRequestBlock *block = [[HttpRequestBlock alloc]initWithUrlPath:@"http://api.fengniao.com/app_ipad//focus_pic.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&mid=19932" Block:^(BOOL isSucceed, HttpRequestBlock *http) {
        if (isSucceed) {
