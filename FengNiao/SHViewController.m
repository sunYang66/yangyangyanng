...
@interface SHViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>{
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    page = 1;
    self.urlStr = @"http://api.fengniao.com/app_ipad/pic_bbs_list_v2.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&fid=115&page=%d";
