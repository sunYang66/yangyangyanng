...
@interface TSViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>{
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    page = 1;
    self.urlStr = @"http://api.fengniao.com/app_ipad/pic_bbs_list_v2.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&fid=101&page=%d";
...
- (void)createCollectionView{
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 54, WIDTH, HEIGHT) collectionViewLayout:layout];
