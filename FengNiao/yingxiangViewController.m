...
@interface yingxiangViewController ()<UICollectionViewDelegate, UICollectionViewDataSource>{
...
- (void)loadData{
    self.urlStr = @"http://api.fengniao.com/app_ipad/news_list.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&cid=278&page=%d";
...
- (void)createView{
    HttpRequestBlock *block = [[HttpRequestBlock alloc]initWithUrlPath:@"http://api.fengniao.com/app_ipad//focus_pic.php?appImei=99000505856649&osType=Android&osVersion=4.1.1&mid=19930" Block:^(BOOL isSucceed, HttpRequestBlock *http) {
        if (isSucceed) {
